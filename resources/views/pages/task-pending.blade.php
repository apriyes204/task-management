                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center justify-content-between" style="width: 10%">
                                            <button onclick="openEditModal('{{ $item->id }}', '{{ $item->name }}')" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editTaskModal_{{ $item->id }}" role="button">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                            <div class="modal fade" id="editTaskModal_{{ $item->id }}" tabindex="-1" aria-labelledby="editTaskModalLabel" aria-hidden="true">
                                                @include('pages.editTask', ['item' => $item]) <!-- Pastikan Anda mengirim data item ke modal -->
                                            </div>
